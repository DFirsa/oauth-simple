...
/**
 * Represents the value of a HTTP cookie, transferred in a request. RFC 2109
 * specifies the legal characters for name, value, path and domain. The default
 * version of 1 corresponds to RFC 2109.
 * 
